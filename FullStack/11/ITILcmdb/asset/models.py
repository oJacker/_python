...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self,email,name,password):
        """
        Create and saves a superuser with the given email, date of birth and password
        :param email:
        :param name:
        :param password:
        :return:
...
class Asset(models.Model):
    ...
    asset_tpye = models.CharField(choices=asset_tpye_choices,max_length=64,default='server')
    name = models.CharField(max_length=64,unique=True)
    sn = models.CharField(u'资产SN号',max_length=128,unique=True)
    manufactory = models.ForeignKey('Manufacory',verbose_name=u'制造商',null=True, blank=True,on_delete=models.CASCADE)
...
class Server(models.Model):
    ...
    sub_asset_type = models.SmallIntegerField(choices=sub_asset_tpye_choices, verbose_name="服务器类型", default=0)
    created_by = models.CharField(choices=created_by_choices, max_length=32,
                                  default='auto')
    # auto: auto created,   manual:created manually
